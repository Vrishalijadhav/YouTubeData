...
def display_app_instructions():
    ...
    # GitHub link
    github_link = "#### :orange[GitHub Link]: [Project Repo](https://github.com/Vrishalijadhav/YouTubeData.git)"
    col1.markdown(github_link)

    # LinkedIn link
    linkedin_link = "#### :orange[Contact Me]: [@LinkedIn](https://www.linkedin.com/in/vrishali-jadhav-1a0aba279)"
